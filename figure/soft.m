...
xlim([0, 12]); xticks([0, 4, 8, 12]);
ylim([-0.06, 0.06]); yticks([-0.05, 0.05]);
xlabel('$t$', 'interpreter', 'latex', 'Position', [6, -0.07]);
ylabel('$u$', 'interpreter', 'latex', 'Position', [0, 0], 'FontSize', 12);
...
scatter(bifurcation.hrzn, bifurcation.vrtc, 1, 'filled', 'MarkerFaceAlpha', 0.1, 'MarkerFaceColor', 'k')
box on
xticks([0.1, 0.16, 0.24, 0.3]); yticks([-0.3, 0.3]);
xlabel('$d$', 'interpreter', 'latex', 'Position', [0.2, -0.4]);
ylabel('$v$', 'Interpreter', 'latex', 'Position', [0.1, 0], 'FontSize', 12);
...
box on
xticks([0.1, 0.16, 0.24, 0.3]);
ylim([-3, 1]); yticks([-3, 0, 1]);
xlabel('$d$', 'interpreter', 'latex', 'Position', [0.2, -3.5]);
ylabel('$\lambda$', 'interpreter', 'latex', 'Position', [0.1, -1]);
